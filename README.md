...
4. You are a voyeur and you want to take a screenshot every 10 seconds to monitor what your spouse is doing on his / her computer. [BINARY](https://github.com/AxtMueller/Windows-Batch-Deployment/tree/master/binaries/User-defined%20server%20program/periodic-screen-capture) [SOURCE](https://github.com/AxtMueller/Windows-Batch-Deployment/tree/master/source/udsp-screen-capture)
