...
These screenshots are from the server programs (EXE version and WEB version). The client programs run in the background without user interface, so I cannot make screenshots for them.  
